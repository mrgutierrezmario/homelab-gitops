...
Status: **phase 3 done** (2026-09-21) — cluster and platform up on the
current mini (Phase A, 6 GiB VM); InsiderTrack + MCP in staging, restored
nightly-bundle data, public over Funnel. See `README.md`.
